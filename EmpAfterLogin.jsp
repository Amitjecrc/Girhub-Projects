...
<!-- Popup Div Ends Here -->
  ...
  <li class="dropdown">
     ...
     <li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn">Manage Jobs</a>
    <div class="dropdown-content">
        <a href="employer_job_posting.html" id="candidate_registration">New Post </a>
         ...
         <li style="float:right;"><a href="employer_login.html">Logout</a> </li>
...
function carousel() {
    ...
    <table class="pegination_td" style="margin: 3px 150px 0px 0px;width: 990px; boxn-shadow:1px 1px 20px green; border: 1px black;" > 
        <tr> 
            <th style="background-color: green; color: white;">JobId</th> 
