...
function carousel() {
    ...
    <% 
        List list = (List) session.getAttribute("jobdesc"); 
    %> 
        ...
        <tr> 
            <% 
               Data candidateDetailsDTO = (Data)list.get(i); 
                    out.println("<td>" + candidateDetailsDTO.getJid()+ "</td>"); 
                    out.println("<td>" + candidateDetailsDTO.getJtitle()+ "</td>"); 
                    out.println("<td>" + candidateDetailsDTO.getPostDate() + "</td>");
                    out.println("<td>" + candidateDetailsDTO.getJobDesc()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getJminExp()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getJlocation()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getJsalary()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getInterviewLocation()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getJindustary()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getVacancies()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getUgQualification()+ "</td>");
                    out.println("<td>" + candidateDetailsDTO.getPgQualification()+ "</td>");
