<%@ page language="java" contentType="text/html; charset=ISO-8859-1" 
   ...
   <div style="width:1160px; height: auto;background-color: whitesmoke; margin: 0 0 0 100px; border: 1px solid black; box-shadow: 1px 1px 35px black;">
...
<h2>LOG IN</h2>
<hr>
<input id="emailid" name="emailid" placeholder="Email Id" type="text"><br><br>
<input id="password" name="password" placeholder="Password" type="password" style="width:270px; height: 35px;"><br><br>
<center> <input type="submit" value="Enter" style="height:35px; width:200px; color: white; background-color: green; border-radius: 10px;"  /></center>
</form>
</div>
<!-- Popup Div Ends Here -->
</div> 
    ...
    <div class="dropdown-content">
      ...
      <a href="forgot_candidate.html">Forgot password</a>
        ...
        <a href="javascripts:void(0)" class="dropbtn"> Employer</a>
          <div class="dropdown-content">
       <a href=employer_reg.html>New Registration</a>
  ...
  <img style="width:1160px; height:188px" class="mySlides" src="images/jp5.png" style="width:100%">
  <img style="width:1160px; height:188px" class="mySlides" src="images/jp6.jpg" style="width:100%">
  <img style="width:1160px; height:188px" class="mySlides" src="images/jp7.png" style="width:100%">
</div>
                <script>
var myIndex = 0;
carousel();
...
function carousel() {
    ...
    <div style="min-height:400px; width:450px;">
    <table class="hometable" class="pegination_td" style="margin: 3px 150px 0px 0px;width: 990px; boxn-shadow:1px 1px 20px green; border: 1px black;"> 
        <tr> 
    ...
    <script type="text/javascript"><!-- 
            var pager = new Pager('results',10000000);  
            pager.init();  
