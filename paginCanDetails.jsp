...
.modal-footer {
    ...
    <table width ="1157px" border="1" id="results" style="box-shadow:1px 1px 20px #4CAF50; border:1px black;">
          <th style="background-color:green; color: white;">CANDIDATE ID</th>
          <th style="background-color:green; color: white;">FIRST NAME</th>
          <th style="background-color:green; color: white;">MIDDLE NAME</th>
          <th style="background-color:green; color: white;">LAST NAME</th>
          <th style="background-color:green; color: white;">EMAIL</th>
          <th style="background-color:green; color: white;">PASSWORD</th>
          <th style="background-color:green; color: white;">PHONE</th>
          <th style="background-color:green; color: white;">GENDER</th>
          <th style="background-color:green; color: white;">DATE OF BIRTH</th>
          <th style="background-color:green; color: white;">CITY</th>
          <th style="background-color:green; color: white;">STATE</th>
          <th style="background-color:green; color: white;">DATE OF REGISTRATION</th>
        ...
        <tr> 
            <% 
               DataCanDetails candidateDetailsDTO = (DataCanDetails)list.get(i); 
    ...
    <script type="text/javascript"><!-- 
     ...
     <div id="button1">
                 <ul>     
                  <form  action="downloadCandidate" method="post">
...
<form action ="deleteCandidate" method ="post">
    ...
    <div class="modal-content" style="width: 400px; height: auto; box-shadow: 1px 1px 60px black;">
      ...
      <center><h2 style="height:50px;">Enter the Candidate Id</h2></center>
    </div>
    <div class="modal-body" style="height:100px;">
        <input style="height:30px; width: 362px; margin-bottom: 8px; margin-top: 8px;" type="text" placeholder="enter the candidate id " name="id" >
