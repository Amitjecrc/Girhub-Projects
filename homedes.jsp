...
function carousel() {
    ...
    <table class="pegination_td" style="margin: 3px 150px 0px 80px;width: 990px; boxn-shadow:1px 1px 20px green;"border="1" > 
        <tr> 
            ...
            <th style="background-color: green; color: white;">SALARY</th>
            <th style="background-color: green; color: white;">INTERVIEW LOCATION</th>
            <th style="background-color: green; color: white;">INDUSTRY</th>
        ...
        <tr> 
            <% 
               DataHome empListDTO = (DataHome)list.get(i); 
                    ...
                    out.println("<td>" + empListDTO.getJminExp()+ "-"+ empListDTO.getJmaxexp()+ "</td>");
                    ...
                    out.println("<td>" + empListDTO.getJindustry()+ "</td>");
